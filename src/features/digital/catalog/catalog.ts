  ...
  plans: [
    {
      ...
      services: [
        { id: 'website', label: 'Website — Up to 5 Pages', price: 26000, type: 'oneTime', deliverDays: 3, stage: 'build' },
        { id: 'whatsapp', label: 'WhatsApp Button on Every Page', price: 999, type: 'oneTime', deliverDays: 0, stage: 'build' },
        { id: 'gbp', label: 'Google Business Profile Setup', price: 1500, type: 'oneTime', deliverDays: 1, parallel: true, stage: 'setup' },
        { id: 'seo-basic', label: 'Basic SEO Setup', price: 4000, type: 'oneTime', deliverDays: 1, stage: 'setup' },
        { id: 'analytics', label: 'Basic Analytics', price: 2500, type: 'oneTime', deliverDays: 1, parallel: true, stage: 'setup' },
      ],
      addOns: [
    ...
    },
    {
      ...
      services: [
        { id: 'gbp-optimise', label: 'Google Business Profile Optimized for Your City', price: 20000, type: 'oneTime', deliverDays: 1, stage: 'setup' },
    ...
    },
    {
      ...
      services: [
        ...
        { id: 'campaign-exec', label: 'Campaign Execution', price: 12000, type: 'oneTime', deliverDays: 3, stage: 'build' },
