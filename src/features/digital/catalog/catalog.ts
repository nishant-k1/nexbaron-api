  ...
  plans: [
    {
      ...
      services: [
        { id: 'website', label: 'Website — Up to 5 Pages', price: 5000, type: 'oneTime', deliverDays: 3, stage: 'build' },
        { id: 'whatsapp', label: 'WhatsApp Button on Every Page', price: 999, type: 'oneTime', deliverDays: 0, stage: 'build' },
        { id: 'gbp', label: 'Google Business Profile Setup', price: 1000, type: 'oneTime', deliverDays: 1, parallel: true, stage: 'setup' },
        { id: 'seo-basic', label: 'Basic SEO Setup', price: 2000, type: 'oneTime', deliverDays: 1, stage: 'setup' },
        { id: 'analytics', label: 'Basic Analytics', price: 1000, type: 'oneTime', deliverDays: 1, parallel: true, stage: 'setup' },
      ],
      addOns: [
    ...
    },
    {
      ...
      featured: true,
      inherited: { label: 'Everything in Launch', oneTime: 9999, monthly: 2499 },
      services: [
        { id: 'gbp-optimise', label: 'Google Business Profile Optimized for Your City', price: 15000, type: 'oneTime', deliverDays: 1, stage: 'setup' },
        { id: 'local-seo', label: 'Local SEO to Improve Search Visibility', price: 1500, type: 'monthly', deliverDays: 0, stage: 'setup' },
        { id: 'whatsapp-book', label: 'WhatsApp Booking & Reminders', price: 999, type: 'monthly', deliverDays: 1, stage: 'setup' },
        { id: 'seo-opt', label: 'SEO Optimization', price: 999, type: 'monthly', deliverDays: 0.5, stage: 'setup' },
        { id: 'reviews', label: 'Review Management', price: 999, type: 'monthly', deliverDays: 0.5, parallel: true, stage: 'setup' },
        { id: 'social', label: 'Social Media Posts', price: 499, type: 'monthly', deliverDays: 0.5, parallel: true, stage: 'setup' },
      ],
      addOns: [
    ...
    },
    {
      ...
      timelineMode: 'phased',
      foundationDays: 30,
      inherited: { label: 'Everything in Growth', oneTime: 24999, monthly: 4999 },
      expectations: [
      ...
      services: [
        { id: 'unlimited-updates', label: 'Unlimited Content & Page Updates', price: 2500, type: 'monthly' },
        { id: 'social-reels', label: 'Social Media Posts + Reels', price: 2000, type: 'monthly' },
        { id: 'gbp-mgmt', label: 'Google Business Profile Management', price: 1500, type: 'monthly' },
        { id: 'campaign-exec', label: 'Campaign Execution', price: 25000, type: 'oneTime', deliverDays: 3, stage: 'build' },
        { id: 'competitor', label: 'Competitor Analysis', price: 1500, type: 'monthly' },
        { id: 'perf-report', label: 'Monthly Performance Report', price: 1500, type: 'monthly' },
