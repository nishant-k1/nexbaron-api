...
export const launchPlan: CatalogPlan = {
  ...
  addOns: pickServices(['launch-pages', 'launch-photos', 'launch-domain', 'business-email', 'live-chat-widget', 'staff-training', 'branding-identity', 'brochure-pdf', 'ordering-page']),
  ctaLabel: 'Get Launch',
  minimumMonths: 3,
}
