// Category -> service id -> item labels (plain literal data, no imports).
// Categories use popular industry terminology (Web Development, Software
// Development, AI & Automation, Advertising, Content & Copywriting, Graphic
// Design, SEO & Local Marketing, Support & Training) — NOT the internal
// package/section names from service-items-pricing-catalog.ts.
// Regenerate if the catalog changes.

export const SERVICE_ITEMS_MAP: Record<string, Record<string, string[]>> = {
  "Web Development": {
    "website": [
